...
function ErroAlert(e) {
    var index = layer.alert(e, { icon: 5, time: 1500, offset: 't', closeBtn: 0, title: '错误信息', btn: [], anim: 2, shade: 0 });
    layer.style(index, {
        color: '#777'
    }); 
}
...
function SuccessAlert(e) {
    var index = layer.alert(e, { icon: 6, time: 1500, offset: 't', closeBtn: 0, title: '友情提示', btn: [], anim: 2, shade: 0 });
    layer.style(index, {
        color: '#777'
    });
}
