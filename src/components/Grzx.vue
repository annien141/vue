        ...
        <div class="m_right">
            ...
            <table border="0" class="mon_tab" style="width:870px; margin-bottom:20px;" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="60%">邀请人：<span style="color:#555555;">{{yqr}}</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>身份证号：<span style="color:#555555;">{{sfz}}</span></td>
                    <td>注册时间：<span style="color:#555555;">{{creat}}</span></td>
                </tr>
            </table>
...
<script>
    ...
    export default {
        ...
        mounted () {
            axios.post(this.globalAjaxUrl+'api/auth/me',{
                token: this.token,
            })
                .then(response => {
                    this.id=response.data.id
                    this.tel=response.data.tel
                    this.sfz=response.data.sfz
                    this.creat=response.data.created_at
                    this.email=response.data.email
                    this.yqr=response.data.yaoqingren
