...
<div class="soubg">
  <div class="sou">
    ...
    <!--End 所在收货地区 End-->
    <span class="fr">
        	<span class="fl">&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
    ...
    <div class="two_bg">
      <table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td class="car_th" width="140">总价</td>
        ...
        <tr v-for="(val,key) in data" >
          ...
          <td align="center">{{val.shuxing}}</td>
          <td align="center">
            <div class="c_num">
              <input type="button"   class="car_btn_1" disabled />

              <input type="text" v-model="val.num" disabled class="car_ipt"/>

              <input type="button"  class="car_btn_2"   disabled/>
            </div>
          </td>
          <td align="center" style="color:#ff4e00;font-size: 15px;font-weight: bold;">{{val.price}}</td>
          <td align="center" style="font-size: 15px;font-weight: bold;">￥{{val.price*val.num}}</td>
          <!--<td align="center"><a @click="delete1('MyDiv','fade')">删除</a>&nbsp; &nbsp;</td>-->
          <!--<td align="center"><a @click="nobuy(key)" v-on:click="val.num=0">暂不购买</a></td>-->
        </tr>
      ...
      <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="center"><input type="radio" name="ch" checked="checked" value="1"/></td>
        ...
        <tr>
          <td align="center"><input type="radio" name="ch"  value="2"/></td>
        ...
        <tr>
          <td align="center"><input type="radio" name="ch"  value="3"/></td>
      ...
      <ul class="pay">
        <li  v-for="c,index in pays" :class="{checked:index==n}" @click="changeList(index)">{{c}}</li>
      </ul>
      ...
      <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
        ...
        <tr height="70">
          <td align="right"><a @click="fanhui"><img src="../assets/images/buy1.gif" /></a>&nbsp; &nbsp; <a  @click="jiesuan"><img src="../assets/images/btn_sure.gif" /></a></td>
        </tr>
      </table>
    </div>
  </div>
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            totalPrice : function(){
                ...
                for (var i = 0;i< this.data.length;i++) {
                    totalP+=this.data[i].price*this.data[i].num;
                }
                return totalP;
            },
            fanhui:function () {
            ...
            jiesuan:function () {
                var kuaidi=$("input[name='ch']:checked").val();
                axios.post(this.globalAjaxUrl + 'api/car2/jiesuan', {
                    token: this.token,
                })
                    .then(response => {
                        var zongjia=response.data.zongjia
                        var dingdanhao=response.data.dingdanhao
                        location.href="http://localhost/laravel/blog/public/api/pay/index?token="+this.token+"&oid="+dingdanhao+"&price="+zongjia
                    })
        ...
        mounted () {
            axios.post(this.globalAjaxUrl + 'api/car2/showcar', {
                token: this.token,
            })
                .then(response => {
            ...
            axios.post(this.globalAjaxUrl + 'api/car2/address', {
                token: this.token,
            })
                .then(response => {
                    console.log(response.data);
