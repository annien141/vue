  ...
  <div>
    ...
    <div class="soubg">
      <div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl" ref="sp1" v-show="seen=false"> {{this.$route.query.aid}}</span>
          <span class="fl" ref="sp2" v-show="seen=false"> {{shangpin}}</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
    ...
    <div class="i_bg">
      ...
      <div class="content">
        ...
        <div id="tsShopContainer">
          <div id="tsImgS"><a href="../assets/images/p_big.jpg" title="Images" class="MagicZoom" id="MagicZoom"><img src="../assets/images/p_big.jpg" width="390" height="390" /></a></div>
...
<!--          <img class="MagicZoomLoading" width="16" height="16" src="../assets/images/loading.gif" alt="Loading..." />-->
        ...
        <div class="pro_des">
          <div class="des_name">
            <p v-for="(val,key) in data" v-if='key<=0'>{{val.goods_name}}</p>
          ...
          <div class="des_choice">
            ...
            <ul>
              <li v-for="(val1,key1) in data" @click="add(key1,$event)" :class="{'checked':key1==n}" v-bind:value="val1.shuxing" >{{val1.shuxing}}</li>
            </ul>
          </div>
          ...
          <div class="des_join">
            <div class="j_nums">
              <input type="text" value="1" class="n_ipt" id="num"/>
              <input type="button" onclick="addUpdate(jq(this));" class="n_btn_1" />
              <input type="button" onclick="jianUpdate(jq(this));" class="n_btn_2" />
            </div>
            <span class="fl" v-if="n===-1"><img src="../assets/images/j_car1.png" /></span>
            <span class="fl" v-else><a @click="addcar('MyDiv1','fade1')"><img src="../assets/images/j_car.png" /></a></span>
          </div>
        </div>
      ...
      <div id="MyDiv1" class="white_content">
        <div class="white_d">
          ...
          <div class="notice_c">
            ...
            <table border="0" align="center" style="margin-top:;" cellspacing="0" cellpadding="0" v-if="token==null">
              <tr valign="top">
                <td width="40"><img src="../assets/images/s_close.gif" /></td>
                <td>
                  <span style="color:#3e3e3e; font-size:18px; font-weight:bold;">您还没有登录</span><br />
                  必须登录才能加入购物车
                </td>
              </tr>
              <tr height="50" valign="bottom">
                <td>&nbsp;</td>
                <td><a onclick="CloseDiv_1('MyDiv1','fade1')" class="b_buy">关闭 </a></td>
              </tr>
            </table>

            <table border="0" align="center" style="margin-top:;" cellspacing="0" cellpadding="0" v-else-if="token!=null && al=='已添加'">
              <tr valign="top">
                <td width="40"><img src="../assets/images/s_close.gif" /></td>
                <td>
                  <span style="color:#3e3e3e; font-size:18px; font-weight:bold;">此商品已添加到购物车！</span><br />
                  修改了数量
                </td>
              </tr>
              <tr height="50" valign="bottom">
                <td>&nbsp;</td>
                <td><a @click="car" class="b_sure">去购物车结算</a><a onclick="CloseDiv_1('MyDiv1','fade1')" class="b_buy">关闭 </a></td>
              </tr>
            </table>

            <table border="0" align="center" style="margin-top:;" cellspacing="0" cellpadding="0" v-else>
              <tr valign="top">
                <td width="40"><img src="../assets/images/suc.png" /></td>
                <td>
                  <span style="color:#3e3e3e; font-size:18px; font-weight:bold;">添加成功！</span><br />
                  宝贝已成功添加到购物车
                </td>
              </tr>
              <tr height="50" valign="bottom">
                <td>&nbsp;</td>
                <td><a @click="car" class="b_sure">去购物车结算</a><a onclick="CloseDiv_1('MyDiv1','fade1')" class="b_buy">继续购物</a></td>
              </tr>
            </table>
    ...
    export default {
        ...
        methods : {
           add:function (item,e) {
               var _this=this
               this.n = item;
               this.shangpin=e.target.attributes[0].value;
               axios.get(this.globalAjaxUrl+"test/price?shuxing="+e.target.attributes[0].value)
            ...
            addcar:function (show_div,bg_div) {
                var num=document.getElementById("num").value
                var gid=this.$refs.sp1.innerHTML;
                var shangpin=this.$refs.sp2.innerHTML;
                ...
                axios.post(this.globalAjaxUrl+'api/car/car',{
                    shangpin: shangpin,
                    gid:gid,
                    num:num,
                    token:this.token,
        ...
        mounted () {
            var _this=this
            var sp1=this.$refs.sp1.innerHTML;
            axios.post(this.globalAjaxUrl+'test/huopin',{
                sp1: sp1,
                token:this.token,
            })
                .then(response=> {
            ...
            axios.post(this.globalAjaxUrl+'test/price1',{
                sp1: sp1,
            })
                .then(function (response) {
                    _this.price=response.data[0].price+"-"+response.data[1].price
                })
        },
    }
</script>
