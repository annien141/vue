  ...
  <div>
    <div class="soubg">
      <div class="sou">
        ...
        <span class="fr">
        <span class="fl">您好,
          <a @click="login" v-if="name ==null">登录</a>
          <a @click="grzx" v-else>{{name}}</a>
        ...
        <span class="ss">
          <div class="ss_list">
            ...
            <span class="fr" v-if="name!==''">|&nbsp;<a @click="logout">退出&nbsp;</a></span>
        </span>
      </div>
    </div>
    <div class="top">
    ...
    <div class="menu_bg">
      <div class="menu">
        ...
        <div class="nav">
          ...
          <div class="leftNav">
            <ul>
              <li v-for="valq in quanbu">
                <div class="fj">
                  <span class="n_img"><span></span><img src="../assets/images/nav1.png" /></span>
                  <span class="fl">{{valq.cat_name}}</span>
                </div>
                <div class="zj">
                  <div class="zj_l">
                    <div class="zj_l_c" v-for="valqq in valq.child">
                      <h2>{{valqq.cat_name}}</h2>
                      <a v-for="va in valqq.child">
                        {{va.cat_name}}
                      </a>
                    </div>
    ...
    <div class="i_bg bg_color">
            ...
            <div id="block1">
              <div id="botton-scroll1" style="visibility: visible; overflow: hidden; position: relative; z-index: 2; left: 0px; width: 1200px;">
                <ul class="featureUL" style="margin: 0px; padding: 0px; position: relative; list-style-type: none; z-index: 1; width: 3600px; left: -2400px;">
                  <li class="featureBox" style="overflow: hidden; float: left; width: 238px; height: 228px;" v-for="a in info">
                    <div class="box">
      ...
      <!--Begin 进口 生鲜 Begin-->
      <div v-for="f in info1">
        <div v-for="(k1,v1) in f">
          <div class="i_t mar_10">
            <span class="floor_num">2F</span>
            <span class="fl">{{v1}}</span>
            <span class="i_mores fr"><a></a></span>
          </div>
          <div class="content">
            <div class="fresh_mid">
              <ul>
                <li v-for="g in k1">
                  <router-link :to="{path: '/Product',query:{aid:g.goods_id}}">
                  <div class="name">

                    <a >{{g.goods_name}}</a>
<!--                    <input v-model="g.goods_id" ref="ip1">-->
                  ...
                  <div class="img">
                    <a>
                      <img src="../assets/images/food_1.jpg" width="185" height="155" />
...
<script>
    ...
    export default {
        ...
        mounted () {
            ...
            axios
                .get(this.globalAjaxUrl+'test/test')
                .then(response => (this.info = response.data))
                .catch(function (error) { // 请求失败处理
                    console.log(error);
                });
            axios
                .get(this.globalAjaxUrl+'test/fenlei1')
                .then(response => (this.info1 = response.data))
                .catch(function (error) { // 请求失败处理
                    console.log(error);
                });
            axios
                .get(this.globalAjaxUrl+'test/quanbufenlei')
                .then(response => (this.quanbu = response.data))
                .catch(function (error) { // 请求失败处理
                    console.log(error);
                });
        },
